...
futures = [
  'ES=F', 'NQ=F', 'YM=F', 'RTY=F', 'BTC=F', 'ETH=F', '6A=F', '6B=F', '6C=F', '6J=F',
  'CL=F', 'RB=F', 'NG=F', 'GC=F', 'SI=F', 'SR3=F', 'HG=F', 'HE=F', 'HO=F', 'UB=F',
  'ZB=F', 'ZC=F', 'ZF=F', 'ZN=F', 'ZS=F', 'ZT=F', 'ZW=F'
]

combined_list = []
combined_list = sp500 + etfs + futures
